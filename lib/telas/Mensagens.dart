...
import 'dart:io';
import 'package:pizza_time/modelo/Conversa.dart';
import 'package:pizza_time/modelo/Usuario.dart';
import 'package:pizza_time/modelo/Mensagem.dart';
...
class Mensagens extends StatefulWidget {
  static final nomeTela = "/mensagens";
...
class _MensagensState extends State<Mensagens> {
  ...
  _salvarConversa(Mensagem msg) {
    ...
    cRemetente.nome = widget.contato
    ...
    //_urlImagemDestinatario;  // tem que ficar a imagem do destinatario
    ...
    cDestinatario.idRemetente =
        _idUsuarioDestinatario; // troca para que o destinatario possa recuperar a ultima mesmo nao sido criada por ele
  ...
  _enviarFoto() async {
    PickedFile pf = await _imagePicker.getImage(
        source: ImageSource
  ...
  Widget build(BuildContext context) {
    widget.contato = ModalRoute.of(context).settings.arguments;
